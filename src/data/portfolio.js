...
export const projects = [
  {
    ...
    images: [
      { src: '/images/face-access-1.jpeg', caption: 'Tableau de bord RH — suivi temps réel des présences et absences' },
      { src: '/images/face-access-2.jpeg', caption: 'Kiosque de pointage — interface de reconnaissance faciale employé' },
      { src: '/images/face-access-3.jpeg', caption: 'Scan biométrique en cours — analyse IA avec YOLOv8 + DeepFace (80%)' },
      { src: '/images/face-access-4.jpeg', caption: 'Pointage réussi — identification et enregistrement instantanés' },
      { src: '/images/face-access-5.jpeg', caption: 'Accès refusé — identité non reconnue, instructions claires affichées' },
      { src: '/images/face-access-6.jpeg', caption: 'Backend Python — FastAPI + 12 endpoints + base PostgreSQL' },
    ],
  },
  {
    id: 6,
    title: 'CRM IA Automation',
    subtitle: 'Système CRM complet — 4 workflows n8n autonomes',
    description:
      'Système CRM entièrement automatisé construit sur 4 workflows n8n enchaînés : ingestion leads depuis Google Sheets, relances email par agent IA avec mémoire (OpenAI), surveillance des réponses Gmail et qualification automatique, archivage des leads froids après 48h. Zéro intervention humaine.',
    highlights: ['4 workflows n8n', 'IA + Mémoire OpenAI', 'Gmail Watch', 'Auto-archivage 48h'],
    stack: ['n8n', 'OpenAI API', 'PostgreSQL', 'Gmail API', 'Google Sheets', 'JavaScript'],
    accent: '#f59e0b',
    github: null,
    live: null,
    category: 'Automatisation IA',
    images: [
      { src: '/images/crm-1.jpeg', caption: 'WF0 — Ingestion leads depuis Google Sheets vers PostgreSQL (schedule 8h)' },
      { src: '/images/crm-2.jpeg', caption: 'WF1 — Agent IA de relances email personnalisées avec mémoire OpenAI' },
      { src: '/images/crm-3.jpeg', caption: 'WF2 — Surveillance réponses Gmail + qualification automatique des leads' },
      { src: '/images/crm-4.jpeg', caption: 'WF3 — Archivage automatique des leads sans réponse après 48h' },
      { src: '/images/crm-5.jpeg', caption: 'Données leads — entreprises Casablanca scrappées avec contacts validés' },
    ],
  },
  {
    id: 4,
    ...
    description:
      'Agent IA de prospection automatisée qui recherche, filtre et génère des leads qualifiés depuis Google Maps et le web. Validation stricte : déduplication, vérification site web, extraction email/téléphone.',
    highlights: ['Leads automatisés', 'Google Maps Scraping', 'Filtrage strict', 'PostgreSQL'],
    ...
    images: [
      { src: '/images/lead-gen-1.jpeg', caption: 'Pipeline Lead Generation v6 — Google Maps Scraping + validation stricte + dedup' },
      { src: '/images/crm-5.jpeg', caption: 'Résultat — leads validés avec nom entreprise, ville, téléphone et email' },
    ],
  },
  {
    id: 5,
    ...
    description:
      'Système automatisé d\'envoi de fiches de paie PDF aux employés via WhatsApp. Déclenché par Google Drive, il recherche le numéro dans Google Sheets, convertit le PDF en Base64, envoie via Evolution API et archive le fichier.',
    highlights: ['WhatsApp PDF', 'Google Drive', 'Zero intervention', 'Auto-archivage'],
    stack: ['n8n', 'Evolution API', 'Google Drive', 'Gmail API', 'Google Sheets'],
    accent: '#7c3aed',
    github: null,
    live: null,
    category: 'Automatisation RH',
    images: [
      { src: '/images/hr-1.jpeg', caption: 'Workflow RH — détection PDF → lookup numéro → envoi WhatsApp → archivage' },
      { src: '/images/hr-2.jpeg', caption: 'Google Drive — dossiers envoi-BP (en attente) et Archive-BP (traités)' },
      { src: '/images/hr-3.jpeg', caption: 'Feuille de correspondance — nom fichier PDF / numéro WhatsApp employé' },
    ],
  },
  {
    id: 2,
